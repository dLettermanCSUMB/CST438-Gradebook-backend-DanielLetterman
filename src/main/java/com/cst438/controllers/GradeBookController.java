...
public class GradeBookController {
	...
	public CourseListDTO getInstructorCourses(){

		String email = "dwisneski@csumb.edu";  // user name (should be instructor's email)

		List<Course> courses = courseRepository.findByInstructor(email);
	...
	public void createAssignment(@RequestBody AssignmentListDTO.AssignmentDTO assignment) {
		...
		Course c = courseRepository.findByInstructorAndId(email, assignment.courseId).get(0);
		Date d = new Date(Long.parseLong(assignment.dueDate));
